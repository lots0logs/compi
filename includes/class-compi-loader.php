...
class Compi_Loader {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array $actions The actions registered with WordPress to fire when Compi loads.
	 */
	protected $actions;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array $filters The filters registered with WordPress to fire when Compi loads.
	 */
	protected $filters;
