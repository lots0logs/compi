...
if ( ! class_exists( 'Compi_Settings_Page' ) ) {

/**
 * Compi_Settings_Page
 */
class Compi_Settings_Page {
	...
	public function output_sections() {
		...
		foreach ( $sections as $id => $label ) {
			...
			$section_link = admin_url( 'admin.php?page=' . COMPI_PAGE . '-settings&tab=' . $this->id . '&section=' . sanitize_title( $id ) );
	...
	public function save() {
		...
		if ( $current_section ) {
			do_action( 'compi_update_options_' . $this->id . '_' . $current_section );
		}
	} // END save()
