 ...
 *
 */
require_once( plugin_dir_path( __FILE__ ) . 'public/class-compi.php' );
 ...
 * @TODO:
 *
 * - replace Compi with the name of the class defined in
 *   `class-plugin-name.php`
 */
register_activation_hook( __FILE__, array( 'Compi', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'Compi', 'deactivate' ) );
 ...
 *   `class-plugin-name.php`
 */
add_action( 'plugins_loaded', array( 'Compi', 'get_instance' ) );
 ...
 * - replace Compi_Admin with the name of the class defined in
...
if ( is_admin() && (!defined( 'DOING_AJAX' ) || !DOING_AJAX ) ) {
	...
	add_action( 'plugins_loaded', array( 'Compi_Admin', 'get_instance' ) );
}
