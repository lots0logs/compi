 ...
 * functionality, then refer to `class-compi-admin.php`
 *
...
class Compi {
	...
	/**
	 * @TODO - Rename "compi" to the name of your plugin
	 *
	 ...
	 * @var      string
	 */
	protected static $plugin_slug = 'compi';
	 ...
	 * @var      string
	 */
	protected static $plugin_name = 'Compi';
